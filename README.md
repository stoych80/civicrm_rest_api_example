# CiviCRM Rest API Example

Using hooks from the "Contact Form 7" plugin - when a "Contact Form 7" form is submitted the information is sent to CiviCRM in another website using its Rest api. This creates/updates an individual contact in civicrm and/or perform other action(s) (adds a note, phone or tag, etc.) for the contact.
